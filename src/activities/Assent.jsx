...
// "Ready! Set! Dedicate!" intervention: a text_prompt (title + this body)
// followed by a Yes/No `choice` item whose content_json.exit_on ends the
// session on "no". This component is the reviewable sandbox mirror of that
// flow.
    ...
    <div className="max-w-[620px] mx-auto">
      ...
      <div className="bg-ctac-teal-50 border border-ctac-teal-200 rounded-2xl p-5">
        <p className="text-[17px] leading-relaxed text-slate-800 mb-1">
          By selecting “yes” below, you are agreeing to be in the study. If you
          do not want to be in the study, select “No”.
        </p>
        <p className="text-[19px] font-semibold text-ctac-navy mb-4">
          Do you want to continue in the study?
        </p>
        <div className="flex flex-col sm:flex-row gap-3">
          <PrimaryButton onClick={() => choose('yes')}>Yes</PrimaryButton>
          <SecondaryButton onClick={() => choose('no')}>No</SecondaryButton>
        </div>
      </div>
    </div>
  )
