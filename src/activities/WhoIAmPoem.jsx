...
// v3.0 (Draft 88 Part B): the Save-as-image download moved to the
...
// (The poem's standalone SVG keepsake builder was removed in v3.0 —
// the consolidated post-posttest plan keepsake includes the poem lines.)
