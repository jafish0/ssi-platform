...
// ---------- Done state: letter keepsake ----------
//
// Shows the kid's letter back to them so they can read it. v3.0 (Draft 88
// Part B): the Save-as-image download moved to the post-posttest
// completion screen — nothing may invite the participant out of the app
// before the post-measures. (In the live flow this screen was never
// reached anyway: the engine advances as soon as onSave resolves. It
// renders in the sandbox.)
  ...
  return (
    <div>
      ...
      <p className="text-[15px] text-slate-700 text-center mb-5 max-w-[520px] mx-auto">
        Your letter is saved — you can look back on it whenever you need a
        reminder or some encouragement.
      </p>
...
// (The letter's standalone SVG keepsake builder was removed in v3.0 —
// the consolidated post-posttest plan keepsake includes the letter text.)
